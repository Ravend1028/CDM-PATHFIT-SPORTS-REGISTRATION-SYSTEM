<?php include 'incs/header.php'; ?>
  ...
  <!-- Home Section -->
  <section class="home_section d-flex justify-content-center position-relative" style="height: 580px;">
    <video src="videos/CDM_1NTRO.mp4" class="object-fit-cover border rounded w-100" autoplay loop></video>
      
    <div class="d-flex flex-column justify-content-center align-items-center container w-100 h-100 position-absolute z-2 text-center">
        <h1 class="text-white mb-3 w-100">
          <span class="text-warning">
            PATHFIT:
          </span> 
          Event Registration Portal for 
